...
@Autonomous(name = "Start Crater / Get Two Gold")
...
//            telemetry.update();
//            idle();
            robot.encoderRunTurn(45,-45,.36,.24);
            sleep(3500);
            robot.finishMovement();
            idle();
            telemetry.addData("run complete","");
