...
public class Controller {
    ...
    private int x, y, a, b;
    private int right_trigger_pressed, left_trigger_pressed;
    ...
    public boolean leftTriggerOnce() {
        return 1 == left_trigger_pressed;
    }

    public boolean rightTriggerOnce() {
        return 1 == right_trigger_pressed;
    }

    public boolean leftTriggerPressed() {
        return (left_trigger_pressed > 0);
    }
    public boolean rightTriggerPressed() {
        return (right_trigger_pressed > 0);
    }
}
